  ...
  return (
    <section className="min-h-screen w-full flex flex-col relative" id="home">
      <div className="w-full mx-auto flex flex-col mt-36 lg:mt-20 c-space gap-3">
        ...
        <p className="hero_tag text-white font-thin">I Build Websites with Next Gen Design and UI.</p>
      </div>
      ...
      <div className="absolute bottom-5 left-0 right-0 w-full z-10 c-space ">
        <a href="#about" className="w-fit ">
          <Button name="Let's Build Your Dream Website" isBeam containerClass="sm:w-fit w-full sm:min-w-96 " />
        </a>
      </div>
    </section>
  );
